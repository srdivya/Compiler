...
public class CodeGenVisitor implements ASTVisitor, Opcodes {
	...
	public Object visitProgram(Program program, Object arg) throws Exception {
		...
		{
			mv.visitLocalVariable(dec.getIdent().getText(), dec.getTypeName().getJVMTypeDesc(), null, startRun, endRun, dec.getSlot());
		}
	...
	public Object visitAssignmentStatement(AssignmentStatement assignStatement, Object arg) throws Exception {
		...
		if(assignStatement.getE().typeName.isType(TypeName.IMAGE))
			mv.visitInsn(DUP);
	...
	public Object visitBinaryChain(BinaryChain binaryChain, Object arg) throws Exception
	{
		...
		if(binaryChain.getE1().firstToken.isKind(OP_HEIGHT) || binaryChain.getE1().firstToken.isKind(Kind.OP_WIDTH)
				 || binaryChain.getE1().firstToken.isKind(Kind.KW_XLOC) || binaryChain.getE1().firstToken.isKind(Kind.KW_YLOC))
			mv.visitInsn(DUP);
	...
	public Object visitBinaryExpression(BinaryExpression binaryExpression, Object arg) throws Exception
	{
		...
		else if(binaryExpression.getE0().getTypeName() == TypeName.BOOLEAN && binaryExpression.getE1().getTypeName() == TypeName.BOOLEAN)
		{
			binaryExpression.getE0().visit(this, arg);
			binaryExpression.getE1().visit(this, arg);
			switch (binaryExpression.getOp().kind)
		...
		else if (binaryExpression.getE0().getTypeName() == TypeName.IMAGE && binaryExpression.getE1().getTypeName() == TypeName.IMAGE )
		{
			binaryExpression.getE0().visit(this, arg);
			binaryExpression.getE1().visit(this, arg);
			switch (binaryExpression.getOp().kind)
		...
		else if (binaryExpression.getE0().getTypeName() == TypeName.IMAGE && binaryExpression.getE1().getTypeName() == TypeName.INTEGER )
		{
			binaryExpression.getE0().visit(this, arg);
			binaryExpression.getE1().visit(this, arg);
			switch (binaryExpression.getOp().kind)
		...
		else if(binaryExpression.getE0().getTypeName() == binaryExpression.getE1().getTypeName())
		{
			binaryExpression.getE0().visit(this, arg);
			binaryExpression.getE1().visit(this, arg);
			switch (binaryExpression.getOp().kind)
	...
	public Object visitBlock(Block block, Object arg) throws Exception
	{
		...
		{
			if(dec.getTypeName().isType(FRAME,IMAGE))
			{
	...
	public Object visitIdentChain(IdentChain identChain, Object arg) throws Exception
	{
		if(identChain.getDec() instanceof ParamDec)
		{
			...
			{
				if(identChain.typeName.isType(TypeName.FILE))
				{
					mv.visitFieldInsn(GETFIELD, className, identChain.getDec().getIdent().getText(), identChain.getDec().getTypeName().getJVMTypeDesc());
					mv.visitMethodInsn(INVOKESTATIC, PLPRuntimeImageIO.className, "write", PLPRuntimeImageIO.writeImageDesc, false);
					mv.visitInsn(DUP);
		...
		else
		{
			if(identChain.isLeft())
			{
				...
				else if(identChain.getTypeName().isType(URL))
				{
	...
	public Object visitIdentExpression(IdentExpression identExpression, Object arg) throws Exception
	{
		...
		{
			if(dec.typeName.isType(TypeName.INTEGER,TypeName.BOOLEAN))
